...
public class FragmentMovie extends Fragment implements MovieAdapter.onSelectData{
    ...
    private void getMovie(){
        progressDialog.show();
        AndroidNetworking.get("https://api.themoviedb.org/3/discover/movie?api_key=d47200df004b2d7b973c4384c4042fe9&language=en-US&sort_by=popularity.desc")
                ...
                .getAsJSONObject(new JSONObjectRequestListener(){
                    ...
                    public void onResponse(JSONObject response){
                        try {
                            ...
                            Toast.makeText(getActivity(), "Gagal menampilkan data!"+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError){
                        ...
                        Toast.makeText(getActivity(), "Tidak ada jaringan internet" + anError, Toast.LENGTH_SHORT).show();
                    }
                });
    }
